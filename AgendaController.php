...
use JavaScript;
use Notifynder;
use reserveio\Concierge\Concierge;
use reserveio\Concierge\Exceptions\DuplicatedAppointmentException;
use reserveio\Concierge\Models\Appointment;
    ...
    public function getAvailability(Business $business, Request $request)
    {
        ...
        if (auth()->user()) {
            ...
            Notifynder::category('user.checkingVacancies')
               ...
               ->to('reserveio\Concierge\Models\Business', $business->id)
               ->url('http://localhost')
               ->send();
        }
